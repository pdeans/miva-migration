...
use App\Http\Conversions\CustomerConversion;
...
class CustomerController extends Controller
{
	...
	public function __construct(Provision $prv, Customer $customer, CustomerConversion $conversion)
	{
		$this->prv        = $prv;
		...
		$this->prv_log    = new ProvisionLogger(log_path().'/customers');
	}
	...
	public function convert(Request $request)
	{
		...
		$xml = $this->conversion->convert($customers);
