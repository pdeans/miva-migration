...
<body>
    <div class="container">
        ...
        @if (isset($api_response))
            <section class="section section=-code section-api">
                <h3 class="title">Last API Response</h3>
                <pre><code class="language-json">{{ $api_response }}</code></pre>
            </section>
        @endif

        @if (isset($prv_response))
            <section class="section section=-code section-prv">
